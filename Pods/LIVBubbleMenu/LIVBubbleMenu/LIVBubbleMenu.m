...
-(void)buttonWasTapped:(UIButton *)button {
    ...
    if([self.delegate respondsToSelector:@selector(livBubbleMenu:tappedBubbleWithIndex:annButton:)]) {
        [self.delegate livBubbleMenu:self tappedBubbleWithIndex:button.tag annButton:button];
    }
}
