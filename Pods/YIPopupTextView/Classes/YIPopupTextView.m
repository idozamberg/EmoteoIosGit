           ...
           textViewInsets:(UIEdgeInsets)textViewInsets
{
    ...
    if (self) {
        ...
        _popupView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 320, 150)];
        ...
        if (buttonStyle == YIPopupTextViewButtonStyleRightDone ||
            ...
            if (!doneButtonColor) {
                doneButtonColor = [UIColor colorWithRed:13.0/255.0 green:73/255.0 blue:98/255.0 alpha:1]; // #449922
            }
