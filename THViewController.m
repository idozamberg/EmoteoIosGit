...
- (void)viewDidLoad
{
    ...
    self.correctPin =[AppData sharedInstance].pinCode;
...
- (void)showPinViewAnimated:(BOOL)animated
{
    ...
    pinViewController.promptTitle = @"SAISIR PIN";
   ...
   // pinViewController.translucentBackground = YES;
    ...
    [self.navigationController presentViewController:pinViewController animated:animated completion:nil];
}
